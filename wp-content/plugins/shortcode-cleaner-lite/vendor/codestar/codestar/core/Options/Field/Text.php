...
class Text extends Field
{
    ...
    public function output()
    {
        ...
        echo '<input type="' . $this->get_element_type() . '" name="' . $this->get_element_name() . '" value="' . wp_filter_nohtml_kses($this->get_element_value()) . '"' . $this->get_element_css_class() . $this->get_element_attributes() . '/>';
