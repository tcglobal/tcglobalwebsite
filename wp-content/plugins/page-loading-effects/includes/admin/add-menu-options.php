		...
		<form method="post" action="<?php echo esc_attr($_SERVER["REQUEST_URI"]); ?>">
			...
			<table class="form-table form-table-3">
				<tbody>
					<tr>
						...
						<p>
							<?php _e('You can read more information here: <a target="_blank" href="https://www.innovedesigns.com/web-development-guide/page-loading-effects-welcomes-wordpress-5-0/">InnoveDesigns.com</a>.', 'ple-txt'); ?>
						</p>
			...
			<table class="form-table form-table-2">
				<tbody>
					...
					<tr>
						<th scope="row">
							<input class="ple_option_2" name="ple_option_2" type="text" placeholder="4000" value="<?php echo get_option('ple_option_2'); ?>">
						</th>
						<td>
				...
				<tbody> 
					<tr>
						<td>
							...
							<p><?php _e('Drop me a message via our contact form <a target="_blank" href="https://innovedesigns.com/">InnoveDesigns.com</a>.', 'ple-txt'); ?></p>
							<p>
