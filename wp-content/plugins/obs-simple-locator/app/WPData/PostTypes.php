...
class PostTypes 
{
	...
	*/
	public function registerLocation()
	{
		...
		register_taxonomy("loc_categories", array($this->pt_labels->name), array("hierarchical" => true, "label" => "Categories", "singular_label" => "Category", "rewrite" => array( 'slug' => 'loc_'.$this->pt_labels->name, 'with_front'=> false )));
		
		register_taxonomy_for_object_type( 'loc_categories', $this->pt_labels->name );
	}
