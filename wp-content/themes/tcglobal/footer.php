<div class="modal fade TermsConditionsCustom-popup" id="TermsConditionsCustom" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal fade PrivacyCustom-popup" id="PrivacyCustom" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog insights-modal contactform-modal modal-lg" role="document">
      <div class="modal-content start-journeymodal book-appointment">
        <div class="modal-header">
...
<script type="text/javascript">
	function changedata(req1,req2) {
	  ...
	  if (x.type == "password") {
	    x.type = "text";
	    $('.'+req2).attr('src', 'https://tcglobaldev.wpengine.com/wp-content/themes/tcglobal/images/eye-icon-open.png');
	  } else {
	    x.type = "password";
	    $('.'+req2).attr('src', 'https://tcglobaldev.wpengine.com/wp-content/themes/tcglobal/images/show.png');
	  }
	}
...
if ( is_front_page() || $slug=='tcglobalclone' ) {
