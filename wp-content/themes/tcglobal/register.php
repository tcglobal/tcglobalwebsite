        ...
        <form class="log-form mt_2" id="user_singup_form" action="" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-6 mb-3">
                  <div class="group">
                    <input type="text" name="firstname" class="w-100 input-value username-field">
                ...
                <div class="col-6 mb-3">
                      ...
                      <div class="group">
                        <input type="text" name="lastname" class="w-100 input-value username-field">
                        <span class="highlight"></span>
                ...
                <div class="col-6 mb-3">
                  ...
                  <div class="group">
                    <input type="text" name="custom_mail" aria-describedby="emailHelp" class="w-100 input-value">
                    <span class="highlight"></span>
                    <label>Email</label>
                  </div>
                ...
                <div class="col-md-6 eventdetail-typenumber mb-3">
                    <div class="group">
                      <div class="map-form-in">
                        <input type="tel" name="telephone" id="txtPhone" class="w-100 number-field telephone" placeholder="Mobile Number" maxlength="13">
                ...
                <div class="col-6">
                  ...
                  <div class="group">
                    <input type="password" name="userpass" id="userpass" class="w-100 input-value " />
                    <span class="highlight"></span>
                ...
                <div class="col-6">
                  ...
                  <div class="group">
                    <input type="password" name="confirm_pass" id="reenterpass" class="w-100 input-value" />
                    <span class="highlight"></span>
