...
<div class="searchtool-banner careers-banner" style="background: url(<?php echo $banner_image[0]; ?>) !important;">
    ...
    <div class="search-result p-t-80 p-b-40">
      <div class="container">
        <div class="row">
              ...
              <div class="col-sm-3 pr-0">
                <div class="careers-list-filter">
                  <h2>Refine your search</h2>
                   <div class="dropdown select-theme filter-dropdown select-box pl-0 m-b-30">
                ...
                <div class="searchlist-topfilter careers-list-topactions pl-0 p-b-20 m-b-20">
                  <div class="row justify-content-between">
                    ...
                    <div class="col-sm-4 pr-0">
                      <p class="text-truncate text-right">Showing <span>8 of <?php echo $total_job; ?></span> Jobs found</p>
                    </div>
          ...
          echo "<div class='career-nav pagination'>";
      ...
      <div class="searchlist-topfilter m-t-60 pl-0">
              <div class="row">
                <div class="col-sm-4">
                  <p>Showing <span>6 of <?php echo $total_job; ?></span> Courses found</p>
                </div>
