               ...
               <div class="col-6">
                   <div class="login_left">
                       <div class="login-left-inner p-t-80 pb_5">
                        <h1>Log in as a ...</h1>
                        <ul class="mt_4 col-8">
                            <li><a href="#" class="current"><img src="<?php echo get_template_directory_uri();?>/images/down_2.png"> <span class="pl-3">Student</span></a></li>
                            <li class="mt_1 mb_1"><a href="https://rmcommunity.tcglobal.com/login">Relationship Mananger</a></li>
                            <li class="mt_1 mb_1"><a href="#">Partner - <em class="upcmg" style="font-style: normal;color:#d91f3d;font-size: 12px;">Coming Soon!</em></a></li>
                        </ul>
                ...
                <div class="login_right p-t-80 register">
                    ...
                    <form class="log-form m-t-80 p-t-20" id="user_forgot_pass" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4 mt_5">
                         <div class="group">
                          <input type="email" name="forgot_email" id="forgot_email" aria-describedby="emailHelp" class="w-100 input-value">
