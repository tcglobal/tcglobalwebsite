...
function get_testimonial_fun($atts){
  ...
  $community .='<div class="desktop-oursolution-comminsight p-t-80 p-b-80">';
    ...
    <div class='modal-dialog insights-modal contactform-modal modal-lg' role='document'>
      <div class='modal-content start-journeymodal ".$activePage." book-appointment'>
        ...
        <div class='modal-body' id='step-progress'>
          ...
          <div class='text-center w-100'>
            <div class='boldheading m-b-70'>When and where can we meet?</div>
          </div>
          <div class='row justify-content-center'>
            <div class='col-sm-8'>
              <div class='row'>
                ...
                <div class='col-sm-12'>
                  <div class='termslink m-b-30 m-t-10'>
                    <div class='customcheckbox'>
                      ...
                      <label for='schedule_check'><span>Don’t have time to meet? Let’s schedule a call.</span></label>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class='col-sm-12'>
                  <div class='termslink m-b-30 m-t-10'>
                    <div class='customcheckbox'>
                      ...
                      <label for='schedule_loc'><span>Don’t have time to meet? Let’s schedule a call.</span></label>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class='col-sm-12'>
                  <div class='termslink m-b-30 m-t-10'>
                    <div class='customcheckbox'>
                      ...
                      <label for='checkbox_verify'><span>Don’t have time to meet? Let’s schedule a call.</span></label>
                    </div>
                  </div>
                </div>
              </div>
