...
<form action="" name="contactform" id="contactform" method="post" class="wpcf7-form wpcf7-acceptance-as-validation theme_1 noErrorMsg">
            ...
            <div class=" termslink m-b-30">
               <div class="customcheckbox">
                  ...
                  <label for="TermsConditions" id="termconditionerror" class="" ><span >Accept TC Global&apos;s <a href="'.get_permalink(134).'">Terms & Conditions</a> and <a href="'.get_permalink(3).'">Privacy Policy</a></span></label>
               </div>
            </div>
