...
if($faq_query->have_posts()) :
	...
	while ($faq_query->have_posts()) : 
			...
			if($k==$count){
				 ...
				 $displayFaqContent .= '</div><div class="row"><div class="col-sm-6"><h4><span class="d-block">Didn\'t find the answer?</span>Explore our Help Center</h4> </div><div class="col-sm-5"><a class="text-white" href="'.$helpcenterlink.'" target="_blank"><button type="button" class="btn btn-theme">help center<img src="'.get_template_directory_uri().'/images/whiteforward.png" /></button></a></div></div></div>	</div></div>';
			}
...
<div class="col-sm-5"><a class="text-white" href="'.$helpcenterlink.'" target="_blank"><button type="button" class="btn btn-theme">help center<img src="'.get_template_directory_uri().'/images/whiteforward.png" /></button></a></div></div></div>	</div></div>'; // no result
	endif;  
}

$terms = '<div class="desktop-faq-verticaltab">
<div class="bg-color"></div>
<div class="container">
<div class="row">
  <div class="col-3">
    <h2 class="desktop-main-heading">FAQ</h2>
