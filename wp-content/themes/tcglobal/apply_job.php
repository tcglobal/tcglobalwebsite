    ...
    foreach ( $locationCats as $locationCat )
    {
      ...
      foreach ( $sub_categories as $sub_category ){
        ...
        if($sub_category->term_id!='48'){
          $location_list .='<li id='.$sub_category->name.'><a><img src='.get_template_directory_uri().'/images/drop-tick.jpg alt="">'.$sub_category->name.'</a></li>';
       }   
    ...
    <div class="bg-color Partner-banner position-relative">
      ...
      <div class="container position-relative">
        ...
        <div class="partner-form-fields events-page-detail p-b-60">
          <div class="row">
            <div class="col-sm-8 careers-jobapply">
              <?php if($succ_msg) { ?>
          ...
          <div class="event-form pt-5 w-100">
            <form name="apply_career_form"  id="apply_career_form" method="POST" action="" enctype="multipart/form-data">
                       ...
                       <div class="col-md-12 p-0 m-b-20">
                         ...
                         <div class="col-md-12 p-0 m-b-20">
                          <div class="row">
                            ...
                            <div class="col-md-6 eventdetail-typenumber pt-2 m-t-2">
                              <div class="row">
                  ...
                  <div class="row list-detail">
                      ...
                      <div class="link-text col-sm-12 mt-0 text-muted" id="sel_letter_name"></div>
                  </div>
                  </div>
