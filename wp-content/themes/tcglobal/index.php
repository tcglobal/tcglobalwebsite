...
<div class="search-result p-t-80 pb-0">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="main-heading col-sm-7 p-0">Ideas  to help catalyse the Global Citizens of tomorrow</h2>
            <div class="row">
              <div class="col-sm-12">
                    ...
                    <div class="row event-topfilter m-t-20 mb-0">
                       ...
                       <div class="col invisible">
                          ...
                          <input type="hidden" name="insight_business" value="<?php echo $_GET['insight_business']; ?>" />
 							...
 							<div class="col">
                          <ul class="filter-dropdown clearfix">
                            <li class="float-right"><div class="dropdown dropdown-theme pl-0">
