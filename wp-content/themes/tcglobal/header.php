               ...
               <div class="row justify-content-between">
                  ...
                  <div class="col-md-9 p-t-10">
                     <ul class="primarynavblock__ul  float-right">
                        ...
                        <?php if($action) { ?>
                        <li><a data-toggle="modal" data-target="#meetingForm" id="meetingtrigger" data-keyboard="false" data-backdrop="static" class="navbutton text-uppercase text-center text-decoration-none" >Request an e-Meet</a></li>
                        <?php } 
                        else{ ?>
                        <li><a data-toggle="modal" data-target="#schedule_form" id="schedule_trigger" data-keyboard="false" data-backdrop="static" class="navbutton text-uppercase text-center text-decoration-none" >Request an e-Meet</a></li>
                        <?php } ?>
