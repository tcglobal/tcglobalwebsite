...
//        $to = get_option('admin_email'); //admin mail id
		$to = ( FALSE !== get_option( 'settings_admin_email' ) ) ? get_option( 'settings_admin_email' ) : get_option( 'admin_email' );
        $headers    = 'From: '.$email . "\r\n";
          ...
          <div class="row">
            <div class="col-sm-12 event-left-banner careers-jobapply">
              ...
              <h2 class="main-heading text-left">
                <span class=""><?php echo get_the_title($jobPostID); ?></span>
              </h2>
              <div class="col-sm-12 p-0">
                <div class="row">
                  <div class="col-sm-12">
                    <p class="event-small-head mb-2">Date added</p>
                    <p class="event-small-head-value"><?php echo get_the_date('d.m.Y', $jobPostID); ?></p>
                  </div>
              ...
              <div class="share-event col-sm-12 px-0 pb-3 mobile-footer-section">
                <h4 class="mt-2 mb-4">Share the job offer</h4>
                <ul class="footerul">
              ...
              <div class="theme-bor-btm m-b-10 mt-4"></div>
              <div class="col-sm-12 tablet-formblock m-t-30">
                <div class="">
                  <h5 class="carrer-medium-head fs-20 m-b-30">Apply to a job</h5>
                </div>
                <div class="careers-job-apply">
                  <div class="w-100">
                    <form name="apply_career_form"  id="apply_career_form" method="POST" action="" enctype="multipart/form-data" >
                      <div class="col-md-12 p-0">
                        <div class="row">
                          <div class="col-md-12 m-b-15">
                            <div class="group">
                              <input type="text" name="user_first_name" id="user_first_name" class="w-100 form-control name-field">
                          ...
                          <div class="col-md-12 m-b-15">
                            <div class="group">
                              <input type="text" name="user_last_name" id="user_last_name" class="w-100 form-control name-field" >
                              <span class="highlight"></span>
                              <span class="bar"></span>
                      ...
                      <div class="col-md-12 p-0">
                        <div class="row">
                          ...
                          <div class="col-md-12 eventdetail-typenumber m-b-20">
                            <label class="mb-2">Your mobile number</label>
                            <div class="row">
                              <div class="col-12">
                                <input type="tel" name="user_phone" id="phone" minlength="10" maxlength="10" class="form-control careers-form-border number-field">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12 p-0">
                        <div class="row">
                          <div class="col-md-12 m-b-20">
                            <label class="mb-0">Your location</label>
                          ...
                          <div class="col-md-12">
                            <label class="mb-0">Your experience</label>
                            <div class="dropdown select-theme filter-dropdown select-box pl-0">
                      ...
                      <div class="theme-bor-btm m-b-30 m-t-30"></div>
                      <h5 class="carrer-medium-head fs-20 m-b-30">Tell us about your experience</h5>
                      <div class="col-12 p-0">
                        <div class=" list-detail">
                          <div class="col-12 p-0 m-b-20"> <div class="row">
                            <div class="col-2 pr-0">
                            ...
                            <div class="col-10 pl-2 pr-0">
                              <label class="uplink">upload your resume
                                <input type="file" name="resume" id="upload_resume" /></label>
                                <div class="link-text text-muted" id="sel_resume_name"></div>
                              <div class="link-text">
                                Supported: doc,docx,pdf,rtf<br>
                                Max file size: 3 MB
                              </div>
                            </div></div></div>
                            <div class="col-12 p-0 m-b-10">
                        ...
                        <div class="show-resume-form">
                          <div class="col-md-12 p-0">
                            <div class="row">
                              <div class="col-md-12 m-b-10">
                                <label class="mb-0">Choose UG Course</label>
                                <div class="dropdown select-theme filter-dropdown select-box pl-0">
                              ...
                              <div class="col-md-12 m-b-10">
                                <label class="mb-0">Choose UG Spec.</label>
                                <div class="dropdown select-theme filter-dropdown select-box pl-0">
                          ...
                          <div class="col-md-12 p-0">
                            <div class="row">
                              <div class="col-md-12 m-b-10">
                                <label class="mb-0">Choose PG Course</label>
                                <div class="dropdown select-theme filter-dropdown select-box pl-0">
                              ...
                              <div class="col-md-12 m-b-10">
                                <label class="mb-0">Choose PG Spec.</label>
                                <div class="dropdown select-theme filter-dropdown select-box pl-0">
                          ...
                          <div class="col-md-12 p-0">
                            <div class="row">
                              <div class="col-md-12 eventdetail-typenumber">
                                <label class="mb-0">Type in preffered CTC</label>
                                <div class="row">
                                  <div class="col-8">
                                    <div class="group">
                                     <input type="text" name="expected_ctc" id="expected_ctc" class="pb-2 w-100" />
                                    </div>
                                  </div>
                                  <div class="col-4 map-form pr-3 pl-0">
                                    <div class="dropdown select-theme filter-dropdown select-box pl-0 mt-1">
                                      <button class="btn btn-secondary dropdown-toggle pt-0 currency_code" id="country_flag" type="button"><img src=""><span>Select</span>
                                      </button>
                          ...
                          <div class="col-12 p-0 mb-4 mt-4">
                            <div class="row list-detail">
                              ...
                              <div class="col-10 p-0">
                                <label class="uplink">upload your cover letter<input type="file" name="cover_letter" id="upload_letter" />
                                </label>
                                <div class="link-text text-muted" id="sel_letter_name"></div>
                              </div>

                            </div>
                          </div>
                          <div class="termslink m-b-30 m-t-30">
                          ...
                          <div class="col-12 p-0">
                            <input type="submit" name="submit" id="submit" value="submit & apply" class="btn btn-theme">
                          </div>
                  ...
                  <div class="col-sm-12 m-t-60 m-b-20 px-0">
                    <a href="<?php echo $url; ?>" class="explorelink text-uppercase text-decoration-none px-0" tabindex="0">Back to job offers<span class="pl-3"><img src="<?php echo get_template_directory_uri(); ?>/images/down_2.png" alt=""></span></a>
                  </div>
                </div>
              </div>
            </div>
