...
$journey_form .="<div class='modal fade' id='start_journey_form' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
    <div class='modal-dialog start-journeymodal insights-modal contactform-modal modal-lg' role='document'>
      <div class='modal-content ".$activePage." '>
        <div class='modal-header'>
          <h3 class='smallheading-modal step-form-title'>First things first <a style='color: #d91f3d;top: 5px;position: relative;' data-toggle='popover' data-trigger='hover' data-trigger='focus' data-content='Amid the current Covid-19 crisis, we have gone fully virtual to protect our student, university and people community! We are live, and connecting, so do not panic, schedule a meeting and keep your hands clean!'><span style='font-size: 30px;' aria-hidden='true'>&#9432;</span></a></h3>		  
