...
<section class="tablet-mainsection">
    <div class="container-fluid">
      <h2 class="main-heading overflow-hide m-b-30 m-t-40">Access denied</h2>
    </div>
 </section>
 <?php 
}else{
...
<section class="tablet-mainsection">
 <form name="onboard_form"  id="onboard_form" method="post" action="">
  <div class="container-fluid">
    <div class="onboard-questions-section contactform-modal start-journeymodal m-t-30 m-b-50">
      <h3 class="smallheading-modal left-0 top-0 position-relative">Onboard with us!</h3>
      <h2 class="main-heading overflow-hide m-b-30 m-t-40">We have few simple questions for you.</h2>
      <div class="row">
        <div class="col-sm-4">
          ...
          <div class="dropdown select-theme filter-dropdown pl-0 m-b-20">
           ...
           <input type="hidden" name="lead_type" value='<?php echo $lead_type?>' id="lead_type">
            ...
            <button class="btn btn-secondary dropdown-toggle pt-0 exp_center" type="button">Choose Center</button>
        ...
        <div class="col-sm-4" <?php echo $available?>>
            ...
            <div class="dropdown select-theme filter-dropdown pl-0 m-b-20 onboard_date_field">
               <input type="text" name="available_from_date" value='' id="available_from_date" class='clsDatePicker onboard_from_date'  readonly>
              <img class='icon' src="<?php echo $calendar_img ?>" />
            </div>
          </div>

          <div class="col-sm-4" <?php echo $userDOB; ?>>
          ...
          <div class="col-sm-4" <?php echo $prep_english?>>
          ...
          <div class="col-sm-4" <?php echo $psychometrics?>>
          <label class="control-label">Purpose</label>
          <div class="dropdown select-theme filter-dropdown pl-0 m-b-20">                    
    ...
    <div id="isRequiredPurpose" <?php echo $isRequiredPurpose?>> 
        ...
        <div class="col-sm-4">
          ...
          <div class="dropdown select-theme filter-dropdown pl-0 m-b-20">
            ...
            <button class="btn btn-secondary dropdown-toggle pt-0 curr_level_study" type="button">Choose Current Level of Study</button>
        ...
        <div class="col-sm-12">
          ...
          <ul class="select-list three-part">
              ...
              <div class="col-sm-12">
                ...
                <ul class="select-list">
                    ...
                    <div class="row justify-content-center m-t-50">
                      <div class="col-sm-3">
                        <button type="button" onclick="onBoardSubmit()" class="btn btn-theme w-100 onboard-submit">onboard<img class="" src="<?php echo bloginfo('template_url') ?>/images/whiteforward.png" /> <i class='onboardloader fa fa-spinner fa-spin ml-3' style='display:none'></i> </button>
                      </div>
                    </div>
                  </div>
                </div>
