  ...
  if($career_custom_query->have_posts()) :
   ...
   while ($career_custom_query->have_posts()) : $career_custom_query->the_post();
    ...
    $nextexclude_job .=$career_id.',';
	  ...
	  $tcjob_list .='<div class="col-12 m-b-20">
                    ...
                    if($career_state){
                      ...
                      $tcjob_list .='<a class="fs-14 apply-link" href="'.get_permalink( $career_id ).'">Apply now<img src="'.get_template_directory_uri().'/images/down_2.png" alt=""></a>
                    </div>
                  </div>';
    endwhile;
...
<div class="careers-banner empty-banner">
...
<div class="search-result p-t-40 p-b-60">
                ...
                <div class="searchlist-topfilter careers-list-topactions pl-0 p-b-20 m-b-10 mt-0">
                  <div class="row justify-content-between">
                    ...
                    <div class="col-5 pr-0">
                      <p class=""><span><?php echo $total_job; ?></span> Jobs found</p>
                    </div>
  ...
  <div class="careers-fixed-button global-space">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12">
          <button type="button" class="btn btn-theme" data-toggle="modal" data-target="#searchfilters">show filters</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- Modal -->
  <div class="modal fade" id="searchfilters" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog insights-modal insights-thanks event-thanks" role="document">
      <div class="modal-content pb-0">
        ...
        <div class="modal-body">
          <div class="row m-t-50 m-b-40">
            <div class="col-sm-12">
              <div class="dropdown select-theme filter-dropdown select-box pl-0">
                <button id="job_btn1" class="btn btn-secondary dropdown-toggle pt-0 career_country" type="button"><span><?php echo $sel_country_val; ?></span></button>
          ...
          <div class="row m-b-40">
            <div class="col-sm-12">
              <div class="dropdown select-theme filter-dropdown select-box pl-0">
                <button id="job_btn2" class="btn btn-secondary dropdown-toggle pt-0 career_city" type="button"><span><?php echo $sel_city_val; ?></span></button>
          ...
          <div class="row m-b-40">
            <div class="col-sm-12">
              <div class="dropdown select-theme filter-dropdown select-box pl-0">
                <button id="job_btn3" class="btn btn-secondary dropdown-toggle pt-0 tc_career-team" type="button"><span><?php echo $sel_team_val; ?></span></button>
          ...
          <div class="row">
            <div class="col-12 m-b-20">
              <a href="javascript:void(0);" onclick="document.getElementById('career_list_form').submit();"><button type="button" class="btn btn-theme w-100">search</button></a>
            </div>
          </div>
        </div>
      </div>
