 ...
 <!-- <a href="" class="chatbox-link">
  ...
  <nav id="mobile-nav">
    <ul class="top-sub-menu">
      <li><a data-toggle="modal" data-target="#checkeligible" data-keyboard="false" data-backdrop="static" class="text-decoration-none portal-form-reset"><img alt="" src="/wp-content/uploads/2019/08/portals.png" width="16" />Portals</a></li>
	...
	<div style="padding:10px 22px;margin-top: -30px;">
		<a data-toggle="modal" data-target="#Covid-19" data-keyboard="false" data-backdrop="static" class="navbutton text-uppercase text-center text-decoration-none" style="width: 100%;font-size: 14px;font-weight: 800;line-height:1.86;font-family: 'Zona Pro';height: 47px;">Covid-19 Notification</a>
    </div>
