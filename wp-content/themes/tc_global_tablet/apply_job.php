                      ...
                      <form name="apply_career_form"  id="apply_career_form" method="POST" action="" enctype="multipart/form-data" >
                       ...
                       <div class="col-12 p-0 mb-4">
                        <div class="row list-detail">
                          ...
                          <div class="col-4 p-0">
                            <label class="uplink">upload your resume<input type="file" name="resume" id="upload_resume" /></label>
                            <div class="link-text mt-0 text-muted" id="sel_resume_name"></div>
                            <div class="link-text">
                      ...
                      <h5 class="carrer-medium-head fs-20 mb-3">…and why would you like to work with us? </h5>
                       ...
                       <div class="col-12 p-0 mb-4 mt-4">
                        <div class="row list-detail">
                          ...
                          <div class="col-8 p-0">
                            <label class="uplink">upload your cover letter<input type="file" name="cover_letter" id="upload_letter" /></label>
                            <div class="link-text mt-0 text-muted" id="sel_letter_name"></div>
                          </div>
                        </div>
                      </div>

                        <div class="termslink m-b-50 m-t-40">
