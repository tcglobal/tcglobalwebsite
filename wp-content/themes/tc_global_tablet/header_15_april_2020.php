    ...
    <div class="row">
	 ...
	 <!--<div class="col-sm-7 text-right">
      ...
      <div class="toggle-navheader">
	   ...
	   <div class="col-sm-7 text-right">
        <?php if($action) { ?>
            <button style="margin-right:35px" type="button" data-toggle="modal" data-target="#meetingForm" id="meetingtrigger" data-keyboard="false" data-backdrop="static" class="btn btn-primary btn-theme">schedule a meeting</button>
        <?php } 
        else{ ?>
        <button style="margin-right:35px" type="button" data-toggle="modal" data-target="#schedule_form" id="schedule_trigger" data-keyboard="false" data-backdrop="static" class="btn btn-primary btn-theme">schedule a meeting</button>
        <?php } ?>
		<button type="button" data-toggle="modal" data-target="#Covid-19" data-keyboard="false" data-backdrop="static" class="btn btn-primary btn-theme">Covid-19 Notification</button>
