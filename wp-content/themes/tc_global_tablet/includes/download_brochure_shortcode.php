...
$download .='<div class="tablet-global-learningfeature global-workspace-solutions pt-0 p-b-30">';
$download .='<h2 class="tablet-main-heading m-b-80">'.$title.'</h2>';
...
if($download_query->have_posts()) :
  while ($download_query->have_posts()) : $download_query->the_post(); 
    ...
    if($formlink == 'schedule_form')
    {
	  ...
	  $download .='<div class="col-sm-12 m-b-20">';
