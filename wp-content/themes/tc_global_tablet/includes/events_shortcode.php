...
if($event_query->have_posts()) :
  while ($event_query->have_posts()) : $event_query->the_post();
      ...
      $cls = 'col-sm-4 three_column m-b-30';
      $img = wp_get_attachment_image_src( get_post_thumbnail_id($event_id), 'medium' );  
		...
		$event_content .='<a href="'.get_permalink( $event_id ).'"><img src="'.$img[0].'" alt="" class="img-fluid w-100 eventthumbnail-eight"></a>';
		...
		$event_content .='<div class="formheading pb-2"><a href="'.get_permalink( $event_id ).'">'.get_the_title($event_id).'</a></div>';
...
$event_content ='<div class="no-record-theme">Record not found</div>';
endif;
...
$events .='<div class="searchtool-banner Events-banner" style="background: url('.$banner_image[0].') !important;background-position: center !important;">';
      $events .='<div class="bg-color"></div>';
      $events .='<div class="container-fluid position-relative">';
    ...
    $events .='<div class="event_section search-form-fields event-form-fields">';
        ...
        $events .='<div class="col-sm-11">';
          $events .='<div class="row">';
            $events .='<div class="col-sm-4">';
              ...
              $events .='<input type="text" class="form-control customised-inputs" name="event_title" value="'.$event_title_val.'">';
            $events .='</div>';
            ...
            $events .='<div class="col-sm-4">';
              $events .='<label class="d-block">Where?</label>';
               $events .='<div class="dropdown select-theme filter-dropdown pl-0 careers-form-border float-none">
                   ...
                   //$events .='<input type="text" class="form-control customised-inputs" name="event_country" value="'.$event_country_val.'">';
            $events .='</div>';
          ...
          $events .='</div>';
        $events .='</div>';
        $events .='<div class="col-sm-1 text-center pt-4 px-0">';
    ...
    $events .='<div class="event search-result" id="event-result">';
      $events .='<div class="container-fluid">';
        $events .='<div class="row">';
          $events .='<div class="col-sm-12">';
            ...
            $events .='<div class="row">';
              ...
              $events .='<div class="row justify-content-end">';
                    $events .='<div class="col-sm-9">';
                      $events .='<div class="row">';
                        $events .='<div class="col-sm-4 text-right">';
                        ...
                        $events .='</div>';
                         ...
                         $events .='<div class="col-sm-4 pl-0">
                            <ul class="filter-dropdown clearfix">
                              <li class="float-right"><div class="dropdown pl-0">
                        ...
                        $events .='<div class="col-sm-4">
                          <ul class="filter-dropdown events-dropdown clearfix">
                            <li class="float-right"><div class="dropdown pl-0">
                              ...
                              <div class="dropdown-menu business-show">'.$event_business.'
                              </div>
                            </div></li>
                          </ul>';
			...
			$events .='<div class="col-sm-12 eventers-section tablet-upcoming-event p-0">';
        ...
        if ( $max_pagenum > 1 ){
              ...
              $events .='<div class="text-center w-100 m-t-60 m-b-40 loadmore">';
              $events .='<a id="more_posts" class="eventbtn text-uppercase text-decoration-none d-block mx-auto">Load more events<span><img src="'.get_template_directory_uri().'/images/tab-downarrow-btn.png" alt="" ></span></a>';
              $events .='</div>';
            }
...
$display_feature_event .='<div class="aboutblock position-relative event-feature tablet-upcoming-event p-b-40">';
      $display_feature_event .='<div class=" position-absolute"></div>';
      $display_feature_event .='<div class="container-fluid">';
        $display_feature_event .='<div class="row ">';
          $display_feature_event .='<div class="col-sm-12 white-head"><div class="main-heading">';
            $display_feature_event .= $title;
          $display_feature_event .='</div></div>';
...
if($feature_query->have_posts()) :
  while ($feature_query->have_posts()) : $feature_query->the_post();
	 ...
	 $feature_val = get_post_meta( $feature_id, '_featured', true );
			...
			$display_feature_event .='<div class="col-sm-4">';
            $display_feature_event .='<div class="course-list">';
              $display_feature_event .='<div class="img-sec">';
                $display_feature_event .='<img src="'.$feature_img[0].'" alt="course-img" class="img-fluid">';
              ...
              $display_feature_event .='<div class="row">';
                $display_feature_event .='<div class="col-sm-12">';
                  $display_feature_event .='<div class="contentslider pr-0">';
...
$displayTopicsName .='<div class="about-signup pt-2 pb-0">';
$displayTopicsName .='<div class="text-center">';
$displayTopicsName .='<div class="main-heading">';
$displayTopicsName .=$title;
$displayTopicsName .='</div>';

$displayTopicsName .='</div>';
$displayTopicsName .='<div class="container-fluid">';
$displayTopicsName .='<div class="row justify-content-center">';
$displayTopicsName .='<div class="col-sm-12 mt-5 tag-section text-center event-popular-topic">';
