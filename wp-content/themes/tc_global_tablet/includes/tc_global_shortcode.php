...
$terms = '';
  $terms .='<div class="footer-bottom">';
      $terms .='<div class="container-fluid">';
        $terms .='<div class="row">';
...
if(empty($layout)){
  ...
  $impact .='<div class="tablet-ourimapact-list">';
  $impact .='<div class="container-fluid">';
  $impact .='<h3 class="sub-heading">'.$tc_head.'</h3>';
  $impact .='<h2 class="main-heading">'.$tc_subhead.'</h2>';
  $impact .='<div class="row">';
}
else{
  $impact .='<div class="global-investments-trackrecord m-t-10">';
  $impact .='<div class="container-fluid">';
  $impact .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
  $impact .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
  $impact .='<div class="row p-t-30 mx-0">';
...
while ($track_record_query->have_posts()) : $track_record_query->the_post();
   ...
   if($link == 'global-ed-form')
    ...
    $impact .='<div class="col-sm-3">';
    $impact .='<div class="row">';
    $impact .='<div class="col-sm-2 p-1 text-right">';
    $impact .='<img alt="" src="'.$impact_arrow[0].'" class="img-fluid" />';
    $impact .='</div>';
    $impact .='<div class="col-sm-10 px-0">';
...
$impact .='</div>';
$impact .='<div class="row">';
$impact .='<div class="col-sm-12 text-center m-t-40">';
...
global $post, $wpdb, $tc_head, $tc_subhead;
  ...
  if($citizenship_id == $cur_postid){
    $citizenship .='<div class="tablet-citizenship-banner-section">';
    $citizenship .='<div class="bannerimg" style="background: url('.$thumb[0].') no-repeat;"></div>';
    $citizenship .='<div class="row mx-0">';
    $citizenship .='<div class="col-sm-6 p-0">';
    $citizenship .='<div class="list-detail">';
    $citizenship .='<h3 class="sub-heading">'.$citizenship_title.'</h3>';
    $citizenship .='<h2 class="main-heading">'.$heading.'</h2>';
    $citizenship .='<p>'.get_post_field('post_content', $cur_postid).'</p>';
    $citizenship .='<a href="'.$citizenship_link.'"><button type="button" class="btn btn-primary">'.$citizenship_button.'<img alt="" src="'.$arrow_img[0].'" class="img-fluid" /></button></a>';
    $citizenship .='</div>';
    $citizenship .='</div>';
    $citizenship .='<div class="col-sm-6 p-0">';
    $citizenship .='</div>';
...
$solutions .='<div class="tablet-home-solution-list">';
...
/*function get_footer_content(){
  ...
  $movement='';
  $movement .='<div class="tablet-steps-content">';
...
$additional_class= get_post_meta( $cur_pageid, 'class_name_for_tab', true );
...
$about_page .= '<div class="tablet-home-banner template-two-banner" style="background: url('.$image[0].') no-repeat;">
      <div class="bgcolor">
        <div class="content">
  ...
  $about_page .= '<div class="'.$additional_class.'" style="background: url('.$image[0].') no-repeat;" >';
  ...
  $about_page .='<h2 class="tablet-main-heading">'.$banner_title.'</h2>';
  $about_page .='</div>';
  $about_page .='</div>';
  $about_page .='</div>';
  $about_page .='</div>';
...
function get_we_are_tcglobal($atts) {
  ...
  if($layout == 'style_one'){
      $about_section .='<div class="tablet-about-explain-section m-t-60 m-b-40">';
      $about_section .='<div class="container-fluid">';
      $about_section .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
      $about_section .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
      $about_section .='<div class="row p-t-30">';
  ...
  elseif($layout == 'style_two'){
      ...
      $about_section .='<div class="about-explain-section m-t-50 m-b-30">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12 mt-3">
              <div class="row">
                <div class="col-sm-6 text-right p-t-80">
                  <img src="'.$tc_img[0].'" class="img-fluid m-t-10" alt="" />
                </div>
                <div class="col-sm-6">
                  <h4 class="pt-0">'.$title.'</h4>
                  <p>'.get_post_field('post_content', $we_are_tcglobal_id).'</p>
                  <h3 class="p-t-30"><a href="'.$url.'"><button type="button" class="btn btn-theme w-auto px-4">'.$button.'</button></a></h3>
                </div>
              </div>
            </div>
          </div>
...
function timeline_details($atts){
  ...
  $timeline .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
  $timeline .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
  $timeline .='<div class="row justify-content-center">';
  $timeline .='<div class="col-sm-12 mt-3">';
  $timeline .='<ul class="timeline">';

//foreach ($res_data3 as $key => $value) {
...
$our_value ='';
$our_value .='<div class="tablet-about-ourvalues">';
$our_value .='<div class="container-fluid">';
$our_value .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
$our_value .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
...
while ( $loop->have_posts() ) : $loop->the_post();
    ...
    $our_value .='<div class="col-sm-3">';
    $our_value .='<img src="'.$our_value_img[0].'" alt="" class="img-fluid" >';
    $our_value .='</div>';
    $our_value .='<div class="col-sm-9">';
...
foreach ($res_data2 as $key => $value) {
  ...
  if($university_details_id == $cur_postid){
      $university .='<div class="tablet-about-university p-t-60 pb-0">';
      $university .='<div class="row">';
      $university .='<div class="col-md-12">';
      $university .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
      $university .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
      //$university .='<div class="brownpath"></div>';
      $university .='<h4>'.$universe_title.'</h4>';
      $university .='<div class="row justify-content-center">';
      $university .='<div class="col-sm-9">';
      ...
      $university .='</div>';
      $university .='</div>';
      $university .='<div class="col-md-12 p-0 pt-3">';
      $university .='<img alt="" src="'.$universe_img[0].'" class="img-fluid" />';
      $university .='</div>';
      $university .='</div>';
      $university .='</div>';
    }
...
global $tc_head, $tc_subhead, $post, $wpdb;
  ...
  if($discover_detail_id == $cur_postid){
      $aboutblock .='<div class="tablet-about-oursolutions">';
      $aboutblock .='<div class="bannerimg" style="background: url('.$attach_img[0].') no-repeat;"></div>';
      $aboutblock .='<div class="container-fluid">';
      $aboutblock .='<div class="row ">';
      $aboutblock .='<div class="col-md-6 p-t-60 p-b-60 pl-5">';
      $aboutblock .='<div class="">';
      $aboutblock .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
      $aboutblock .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
      ...
      $aboutblock .='</div>';
      $aboutblock .='</div>';
      $aboutblock .='<div class="col-md-6 text-center"></div>';
      $aboutblock .='</div>';
      $aboutblock .='</div>';
      $aboutblock .='</div>';
...
function get_member_details($atts){
 ...
 global $tc_head, $tc_subhead, $post, $wpdb, $tc_innerhead, $tc_inner_subhead;
  ...
  $member .='<div class="tablet-about-leadership p-t-60 p-b-80" id="leaderboard">';
  $member .='<div class="container">';

  $member .='<h2 class="tablet-main-heading">'.$tc_head.'</h2>';
  $member .='<h3 class="tablet-sub-heading p-t-30 p-b-30 mb-0">'.$tc_subhead.'</h3>';
  $member .='<div class="row justify-content-center text-center">';
  ...
  if($team_mem_query->have_posts()) :
    ...
    if($subcategory->term_id == $category_one){
       ...
       $member .='<div class="col-sm-4 member-list">';
    ...
    elseif($subcategory->term_id == $category_three){
      ...
      if($j == 1){
         ...
         $member .='<div id="inter_member_show"><h3 class="tablet-sub-heading p-t-30 p-b-30 mb-0">'.$tc_inner_subhead.'</h3>';
         $member .='<div class="row justify-content-center">';
      }

      $member .='<div class="col-3 member-list">';
      $member .='<a href="'.$pageUrl.'" title="'.get_the_title( $team_mem_id ).'"><img src="'.$photo.'" alt="" class="img-fluid profile" /></a>';
      $member .='<h3><img src="'.$team_arrow_img[0].'" alt="" class="img-fluid" >'.get_the_title( $team_mem_id ).'</h3>';
      $member .='<p>'.get_post_meta($team_mem_id, '_member_designation', true ).'</p>';
      $member .='</div>';
...
$about_detail .='<div class="tablet-about-member-view">';
$about_detail .='<div class="tab-chopra-img">';
$about_detail .='<img src="'.$feature_img[0].'" class="img-fluid" />';
$about_detail .='</div>';
$about_detail .='<div class="col-sm-12 p-t-30">';
$about_detail .='<div class="row justify-content-center">';
$about_detail .='<div class="col-sm-10 px-2">';
$about_detail .='<h3>'.get_post_meta( $post->ID, 'title_one', true ).'</h3>';
$about_detail .='<h4>'.get_post_meta( $post->ID, 'title_two', true ).'</h4>';
$about_detail .='<div class="col-sm-12 p-0">';
...
$about_detail .='</div>';
$about_detail .='<div class="row">';
$about_detail .='<div class="col-sm-4 pr-0">';
$about_detail .='<a href="'.get_post_meta( $post->ID, 'button_one_link', true ).'"><button type="button" class="btn btn-block btn-red">'.$btn_one.'<img src="'.$read_img[0].'" alt="" /></button></a>';
$about_detail .='</div>';
$about_detail .='<div class="col-sm-4">';
$about_detail .='<a href="'.get_post_meta( $post->ID, 'button_two_link', true ).'"><button type="button" class="btn btn-block">'.$btn_two.'<img src="'.$about_img[0].'" alt="" /></button></a>';
$about_detail .='</div>';
$about_detail .='</div>';
$about_detail .='</div>';
$about_detail .='</div>';
...
function display_aboutus_read() {
  ...
  global $post, $text_content;
    ...
    $detail_read ='';
    $detail_read .='<div class="tablet-about-member-view">';
    $detail_read .='<div class="tab-chopra-img">';
    $detail_read .='<img src="'.$feature_img1[0].'" class="img-fluid" />';
    $detail_read .='</div>';
    $detail_read .='<div class="col-sm-12 p-t-30">';
    $detail_read .='<div class="row justify-content-center">';
    $detail_read .='<div class="col-sm-10 px-2">';
    $detail_read .='<h3><span class="d-block">'.get_post_meta( $post->ID, 'title_one', true ).'</h3>';
    $detail_read .='<div class="col-sm-12 p-0 mt-3">';
    ...
    $detail_read .='</div>';
    $detail_read .='<div class="row">';
    $detail_read .='<div class="col-sm-4">';
    $detail_read .='<a href="'.get_post_meta( $post->ID, 'button_one_link', true ).'"><button type="button" class="btn btn-block text-left px-0 mt-0">'.$btn_one.'<img src="'.$read_img[0].'" alt="" /></button></a>';
    $detail_read .='</div>';
    $detail_read .='</div>';
    $detail_read .='</div>';
    $detail_read .='</div>';
...
$service .='<div class="container">';
$service .='<div class="row">';
$service .='<div class="col-sm-12">';

while ( $query->have_posts() ) : $query->the_post();
    if($k <= 3){
        if($k == 0){ $service .='<div class="row">';}
    ...
    elseif($k >=4 && $k <=7){
      if($k == 4){ $service .='<div class="row">';}

        $service_img = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );
        $service .='<div class="col">';
        $service .='<img src="'.$service_img[0].'" class="img-fluid" />';
        $service .='<p><span class="d-block">'.get_post_field('post_content', $post->ID).'</p>';
        $service .='</div>';
    ...
    elseif($k>7){
      if($k == 8){
        $service .='<div class="row justify-content-center"><div class="col-sm-6"><div class="row">';
        }
...
$education .='<div class="tablet-icon-horizontaltab p-b-60">';
$education .='<div class="container">';
$education .='<div class="row">';
$education .='<div class="col-12 p-0">';
$education .='<ul class="nav nav-tabs" id="myTab" role="tablist">';
  ...
  while ( $education_query->have_posts() ) : $education_query->the_post();
    ...
    if($i == 1){
          ...
          $education .='<a class="nav-link active" id="'.$active_id.'" data-toggle="tab" href="#'.$active_element.'" role="tab" aria-controls="'.$active_element.'" aria-selected="true">';
          $education .='<img class="default" src="'.$default_img[0].'" alt="" /><img class="current" src="'.$active_img[0].'" alt="" /><span>'.get_the_title($education_id).'</span></a>';
      }
          ...
          $education .='<a class="nav-link" id="'.$active_id.'" data-toggle="tab" href="#'.$active_element.'" role="tab" aria-controls="'.$active_element.'" aria-selected="false">
        <img class="default" src="'.$default_img[0].'" alt="" /><img class="current" src="'.$active_img[0].'" alt="" /><span>'.get_the_title($education_id).'</span></a>';
  ...
  while ( $education_query->have_posts() ) : $education_query->the_post();
      ...
      if($j == 1){
          ...
          $education .='</div>';
          $education .='<div class="col-sm-6 text-right">';
          $education .='<img class="img-fluid" src="'.$edu_img[0].'" alt="" />';
          $education .='</div>';
          $education .='</div>';
          $education .='</div>';
        }
          ...
          $education .='<div class="col-sm-6">';
          $education .=get_post_field('post_content', $ed_id);
          $education .='<a href="'.get_post_meta($ed_id, 'education_link', true ).'"><button type="button" class="btn '.$btn_cls.'">'.get_post_meta($ed_id, 'education_button', true ).'<img src="'.$eduarrow_img[0].'" /> </button></a>';
          $education .='</div>';
          $education .='<div class="col-sm-6 text-right">';
          $education .='<img class="img-fluid" src="'.$edu_img[0].'" alt="" />';
          $education .='</div>';
...
$video ='';
$video .='<div class="tablet-oursolution-watchstory">';
$video .='<div class="videotext"><h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
$video .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>
<img class="video-thumbnail" src="https://tcglobal.wpengine.com/wp-content/uploads/2019/08/video-thumbnail.jpg"></div>';
$video .='<video playsinline="" preload="auto" loop id="myVideo" width="100%" height="100%" >
  <source src="https://tcglobal.wpengine.com/wp-content/uploads/2019/11/tc_global_may-31st.mp4" type="video/mp4">
  </video>
  <a id="myBtn" onclick="videoFunction()"><img src="https://tcglobal.wpengine.com/wp-content/uploads/2019/08/video-play.png"></a>
</div>';
  ...
  $community .='<div class="careers-community-insights p-t-20 p-b-30">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-sm-11">
              <h6 class="tablet-sub-heading">'.$tc_head.'</h6>
              <h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
  $community .='<div class="row p-t-80">';

}
else{
  $community .='<div id="CommunityInsights" class="tablet-oursolution-comminsight p-t-60 p-b-50">';
  $community .='<div class="container">';
  $community .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
  $community .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
  $community .='<section class="team-carousel slider tablet-upcoming-event my-0 p-t-30">';
}
  ...
  while ( $testimonial_query->have_posts() ) : $testimonial_query->the_post();
    ...
    if($layout == "style_two"){
      ...
      $community .='<div class="col-sm-6">
                  ...
                  <h3>'.get_post_field('post_content', $team_id).'</h3>
                </div>';
      }
...
$become_global .='<div class="tablet-globaled-startjourney '.$background_cls.' p-t-60 p-b-40">';
$become_global .='<div class="container">';
$become_global .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
$become_global .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
...
while ($become_global_query->have_posts()) : $become_global_query->the_post();
       ...
       $global_img = wp_get_attachment_image_src( get_post_thumbnail_id($become_global_id), 'full' );
        ...
        $additional_cls = get_post_meta( $become_global_id, 'class_name_for_tab', true );
        $cls_val = '';
        $popup_action = '';
    ...
    if($i ==0){
        ...
        elseif($i ==1){
            ...
            $become_global .='<div class="col-sm-6">';
            $become_global .='<h4 class="fs-20 pl-4 ml-3">'.get_the_title($become_global_id).'</h4>';
            $become_global .='<p class="fs-14 pl-4 ml-3">'.get_post_field('post_content', $become_global_id).'</p>';

            if($button_one){
              $become_global .='<div class="pl-4 ml-3"><a href="'.$link.'" '.$popup_action.'><button type="button" class="btn btn-outline px-0 w-100 '.$cls_val.'">'.$button_one.'</button></a></div>';
            }
...
function start_journey_fun($atts){
  ...
  $additional_class = get_post_meta( $cur_post_id, 'class_name_for_tab', true );
...
$partner .='<div class="tablet-globaled-whysection p-t-60">';
$partner .='<h3 class="tablet-sub-heading">'.$title.'</h3>';
$partner .='<h2 class="tablet-main-heading">'.$subtitle.'</h2>';
$partner .='<div class="container-fluid p-t-20">';
...
while ($global_partner_query->have_posts()) : $global_partner_query->the_post();
  ...
  $partner_img = wp_get_attachment_image_src( get_post_thumbnail_id($global_partner_id), 'full' );
    ...
    $partner .='<div class="row">';
    $partner .='<div class="col-sm-3 text-center">';
    $partner .='<img src="'.$partner_img[0].'" />';
    $partner .='</div>';
    $partner .='<div class="col-sm-8">';
...
if($events_query->have_posts()) :
  while ($events_query->have_posts()) : $events_query->the_post();
      ...
      $event_insight .='<div class="tablet-about-oursolutions tablet-education-about">';
      ...
      $event_insight .='<div class="col-md-8 p-t-60 p-b-60 pl-5">';
      $event_insight .='<div class="">';
      $event_insight .='<h3 class="tablet-sub-heading">'.$tc_head.'</h3>';
      $event_insight .='<h2 class="tablet-main-heading">'.$tc_subhead.'</h2>';
      $event_insight .='<p>'.get_post_field('post_content', $events_postid).'</p>';
      $event_insight .='<div class="tablet-globaled-btn-section m-t-40">';
...
$event_insight .='</div>';
$event_insight .='</div>';
$event_insight .='<div class="col-md-4 text-center"></div>';
$event_insight .='</div>';
$event_insight .='</div>';
$event_insight .='</div>';
...
$global_timeline .='<div class="story-timeline tablet-timeline globaled-timeline mt-2">';
$global_timeline .='<div class="container">';
$global_timeline .='<div class="text-center">';
$global_timeline .='<div class="tablet-sub-heading text-uppercase">'.$tc_head.'</div>';
$global_timeline .='<div class="tablet-main-heading boldheading">'.$tc_subhead.'</div>';
...
while ($timelineed_query->have_posts()) : $timelineed_query->the_post();
       ...
       $timeid = get_the_ID();
          ...
          elseif($line == 2){
                ...
                $global_timeline .='<div class="timeline-panel m-t-20">';
                $global_timeline .='<img src="'.get_post_meta( $timeid, 'announcement_image', true ).'" class="img-fluid m-t-80" alt="" />';
                $global_timeline .='</div>';
                $global_timeline .='</div>';
                $global_timeline .='<div class="timeline-panel float-right">';
          ...
          elseif($line == 7){
              ...
              $global_timeline .='<li>';
              $global_timeline .='<div class="timeline-badge count">'.$line.'</div>';
              $global_timeline .='<div class="timeline-panel part-community">';
              $global_timeline .='<h4 class="mt-3">'.get_the_title($timeid).'</h4>';
              $global_timeline .= get_post_field('post_content', $timeid);
              $global_timeline .='</div>';
              $global_timeline .='<div class="timeline-inverted">';
...
$future .='<div class="tablet-global-learningfeature p-t-50 p-b-40">';
$future .='<div class="gloabal-space">';
$future .='<h2 class="tablet-main-heading">'.$tc_head.'</h2>';
$future .='<p class="p-b-40 p-l-30 p-r-30">'.$tc_subhead.'</p>';
...
$investment .='<div class="story-timeline global-investments-timeline m-t-30">';
$investment .='<div class="container">';
$investment .='<div class="text-center p-b-80">';
$investment .='<h2 class="tablet-main-heading">'.$headingtitle.'</h2>';
$investment .='</div>';
$investment .='<div class="row justify-content-center">';
$investment .='<div class="col-sm-12 mt-3">';
...
while ($investment_query->have_posts()) : $investment_query->the_post();
  ...
  if($jk%2 == 0){  // get even row entry content
      ...
      $investment .='<h4 class="m-t-20">'.get_the_title($investment_id).'</h4>';
      ...
      if($jk == 1){
          ...
          $investment .='<div class="timeline-inverted">';
          $investment .='<div class="timeline-panel float-right">';
          $investment .='<img src="'.get_post_meta( $investment_id, 'announcement_image', true ).'" class="img-fluid m-b-80" alt="" />';
          $investment .='</div>';
          $investment .='</div>';
          $investment .='</li>';
...
function global_section_fun($atts){
   ...
   $global_content .='<div class="aboutblock position-relative inlights-subscribe-block">
        <div class="rightbanner position-absolute" style="background: url('.$attach_img[0].') no-repeat; background-size:cover"></div>
          <div class="row justify-content-end">
            <div class="col-md-6">
              <div class="aboutblock__container p-t-60">
                <h3>'.$title.'</h3>
                <h4>'.$sub_title.'</h4>
                <p>'.$content.'</p>
                <div class="">
                  <a href="'.$citizenship_link.'" class="btn btn-more allformtrigger" '.$popup_action.'>'.$citizenship_button.'</a>
                </div>
              </div>
            </div>
            <div class="col-md-6">
  ...
  elseif($layout == "style_two"){
    $global_content .='<div class="aboutblock position-relative carrers-aboutblock">
        <div class="rightbanner position-absolute" style="background: url('.$attach_img[0].') no-repeat; background-size:cover;background-position: 32% 0;"></div>
        <div class="container-fluid">
          <div class="row ">
            <div class="col-md-6 pr-5">
              <div class="aboutblock__container global-space p-b-60 p-t-60">
                <h2>'.$title.'</h2>
                <h3>'.$sub_title.'</h3>
                <p>'.$content.'</p>
                <div class="globaled-btn-section m-t-40">
                  ...
                  <a href="'.$link_two.'" ><button type="button" class="btn btn-outline w-100 ml-0 m-t-20">'.$button_two.'</button></a>
                </div>
              </div>
            </div>
            <div class="col-md-6">
  ...
  $global_content .='<div class="aboutblock position-relative tablet-citizenship-banner-section">
  <div class="rightbanner position-absolute" style="background: url('.$attach_img[0].') no-repeat; background-size:cover"></div>
  <div class="container ">
    <div class="row ">
      <div class="col-md-6">
...
function career_slider($atts){
  ...
  $career_slider_content .='<div class="careers-workspace-thumbnailslider global-space p-t-20 p-b-40">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <div class="event-left-banner">
         <h2 class="main-heading text-left">'.get_the_title($id).'</h2>
        </div>
...
function job_position($atts){
  ...
  $job_content .='<div class="col-sm-4">
  ...
  $job_position .='<div class="popular-course pt-0 careers-current-position">
        <div class="text-center">
          <div class="main-heading top-30">'.$title.'</div>
          </div>
...
function get_subscribe_data(){
  ...
  $subscribe_from .="<div class='modal fade' id='subscribeModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                    ...
                    <div class='modal-body'>
                      ...
                      <div class='row justify-content-center'>
                          <div class='col-6 m-b-30'>
                            <button type='button' class='btn btn-theme formclose w-100' data-dismiss='modal' aria-label='Close'>Close</button>
                          </div>
                      </div>
...
$portal .="<div class='modal fade' id='checkeligible' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
            <div class='modal-dialog insights-modal contactform-modal modal-lg' role='document'>
              <div class='modal-content' id='formsubmit'  >
                <div class='modal-header'>
                  <div class='text-center w-100 m-t-30 m-b-20'>
                ...
                <div class='modal-body'>
                  <div class='row justify-content-center'>
                    ...
                    <form action='' name='portalform' id='portalform' method='post' class='col-sm-12 wpcf7-form wpcf7-acceptance-as-validation theme_1 noErrorMsg'>
                     <input type='hidden' value='".$current_pageName."' name='student_currentPage' id='student_currentPage'>
                     <input type='hidden' name='ProspectID' id='ProspectID' >
                      <div class='row'>
                        <div class='col-sm-6 m-b-30'>
                          <div class='group'>
                            <input type='text' class='w-100 name-field input-value' novalidate name='student_name' id='student_name' required  />
                            <span class='highlight'></span>
                            <span class='bar'></span>
                            <label>Your name</label>
                          </div>
                      ...
                      <div class='row'>
                        <div class='col-sm-6'>
                          <div class='group enter-mobile-number'>
                            <input type='text' class='input-value number-field portalflag' placeholder='Your mobile number' novalidate minlength='10' maxlength='10' name='student_mobile' id='student_mobile' />
                          </div>
                        </div>
                        <div class='col-sm-6'>
                          <div class='dropdown select-theme filter-dropdown select-box pl-0'>
                        ...
                        data-toggle='dropdown' aria-haspopup='true'
                          ...
                          <input type='hidden'  name='student_service' id='student_service'>
                            <div class='dropdown-menu' aria-labelledby='student_service_text'>
                              <ul>
                                <li class='student_service' data-mydata='Global Education'><a><img src='images/drop-tick.jpg' alt=''>Global Education</a></li>
                                <li  class='student_service' data-mydata='Global Learning'><a class='active'><img src='images/drop-tick.jpg' alt=''>Global Learning</a></li>
                                <li  class='student_service' data-mydata='Global Investments'><a ><img src='images/drop-tick.jpg' alt=''>Global Investments</a></li>
                                <li  class='student_service' data-mydata='WorkSpace'><a ><img src='images/drop-tick.jpg' alt=''>WorkSpace</a></li>
                              </ul>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class='row'>
                        <div class='col-sm-12 m-t-10'>
                          <div class='group'>
                            <textarea class='w-100' placeholder='' rows='4'  name='student_message' id='student_message'></textarea>
                            <span class='bar'></span>
                ...
                <div class='modal-content' id='formresult' style='display:none'>
                  <div class='modal-header'>
                    ...
                    <button type='button' class='close formclose' data-dismiss='modal' aria-label='Close'>
                      <img src='".get_template_directory_uri()."/images/map-close.png' />
                    </button>
                  </div>
                  <div class='modal-body'>
...
$express_interest_from .="<div class='modal fade' id='expressModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
            <div class='modal-dialog insights-modal contactform-modal modal-lg mw-100 mx-3' role='document'>
              <div class='modal-content' id='expresssubmit'  >
                <div class='modal-header'>
                  <div class='text-center w-100 m-t-20 m-b-30'>
                    <div class='boldheading'>
                    ...
                    <form action='' name='express_form' id='express_form' method='post' class='wpcf7-form wpcf7-acceptance-as-validation theme_1 noErrorMsg'>
                     ...
                     <div class='col-sm-12 p-0'>
                      ...
                      <div class='row'>
                        <div class='col-sm-6'>
                          <div class='group enter-mobile-number'>
                            <input type='text' class='input-value number-field expressflag' placeholder='Your mobile number' novalidate name='express_mobile' id='express_mobile' minlength='10' maxlength='10' />
                          </div>
                        </div>
                        <div class='col-sm-6'>
                          <div class='dropdown select-theme filter-dropdown select-box pl-0'>
                          ...
                          <input type='hidden' name='express_service' id='express_service'>
                            <div class='dropdown-menu' aria-labelledby='express_service_text'>
                              <ul>
                                ...
                                <li class='express_service' data-mydata='Global Learning'><a class='active'><img src='".get_template_directory_uri()."/images/drop-tick.jpg' alt=''>Global Learning</a></li>
                      ...
                      <div class='col-sm-12 m-t-20 m-b-40 modal-select2'>
                        <div class='dropdown select-theme filter-dropdown select-box pl-0'>
						<select class='form-control selectbox m-b-20 input-value mutlidropdown' name='university[]'
            ...
            <option value=''>Choose university</option>
                      ...
                      <div class='row justify-content-center'>
                        <div class='col-sm-8 m-b-30'>
                          <button type='button' class='btn btn-theme w-100 expressform'>Send</button>
                        </div>
                      </div>
                    </div>
                    </form>
...
if($current_pageName == 'Global Learning'){
  ...
  $service_section .= "<div class='col-sm-4'>
          ...
          $UserInterestList .="<div class='col-md-6'>
    ...
    <div class='modal-dialog start-journeymodal insights-modal contactform-modal modal-lg' role='document'>
      <div class='modal-content book-appointment ".$activePage." '>
        ...
        <div class='modal-body' id='step-progress'>
          ...
          <h3 class='sub-heading'>Step 1/3</h3>
          <h2 class='main-heading overflow-hide m-b-60'>Let’s cut out the Mr. and Mrs!</h2>
          <div class='p-0'>
            <div class=''>
              <div class='row'>
                <div class='col-sm-6 m-b-30'>
              ...
              <div class='row'>
                ...
                <div class='col-sm-6 m-b-15'>
                  <div class='group enter-mobile-number'>
                     <input type='text' name='userphone' placeholder='Your mobile number' id='userphone' minlength='10' maxlength='10' class='form-control careers-form-border number-field input-value countryflag'>
                  </div>
                </div>
                </div>
              <div class='row'>
              ...
              <div class='row justify-content-center'>
                <div class='col-sm-4'>
                  <button type='button' onClick=show_next('account_details','user_details','bar1','baricon2','$activePage','tab'); class='btn btn-theme w-100' >next <img class='btn-whitearrow' src='".get_template_directory_uri()."/images/whiteforward.png'></button>
                </div>
              </div>
            </div>
          ...
          <h3 class='sub-heading'>Step 2/3</h3>
          <h2 class='main-heading overflow-hide m-b-40'>How can we get in touch?</h2>
              ...
              <div class='row'>
                ...
                <div class='col-sm-6 mt-4'>
                  ...
                  <div class='form-group select-theme filter-dropdown border-bottom-0'>
                    ...
                    <div class='dropdown-menu pick_time_show left-0'>
                      <ul>
                ...
                <div class='row justify-content-center m-t-50'>
                  ...
                  <div class='col-sm-4'>
                    <button type='button' onClick= show_next('user_details','qualification','bar2','baricon3','$activePage','tab'); class='btn btn-theme w-100'>next <img class='btn-whitearrow' src='".get_template_directory_uri()."/images/whiteforward.png'></button>
                  </div>
                </div>
        ...
        <h3 class='sub-heading'>Step 3/3</h3>
          <h2 class='main-heading overflow-hide m-b-40'>How can we help you?</h2>
          ...
          <div class='row justify-content-center m-t-40'>
            ...
            <div class='col-sm-6'>
              <button type='button' onclick=onSubmit('tab'); class='btn btn-theme w-100 journey-btn'>Submit & Onboard!<img class='btn-whitearrow' src='".get_template_directory_uri()."/images/whiteforward.png' /> </button>
            </div>
          </div>
          <div class='group m-b-20 m-t-20' id='journey_success'></div>
          <div class='group m-b-20 m-t-20' id='journey_error'></div>
        </div>
       </form>

        <div class='thank-you-popup' id='Confirmation' style='display:none'>
        <h3 class='sub-heading'>that’s it!</h3>
            <h2 class='main-heading overflow-hide m-b-40'>Thanks for contacting us!</h2>
            <p class='text-center fs-14'>We will reach you shortly and start our journey together.</p>
              <div class='row justify-content-center m-t-50'>
                <div class='col-sm-7'>
                  <button type='button' class='btn btn-theme w-100 px-0'><a class='text-white' href=".$backPageURL.">Back to ".$current_pageName."<img class='' src=".get_template_directory_uri()."/images/whiteforward.png /></a></button>
                </div>
              </div>
        </div>
...
$schedule_meeting_form .="<div class='modal fade' id='schedule_form' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
    <div class='modal-dialog start-journeymodal insights-modal contactform-modal modal-lg' role='document'>
          ...
          <div class='p-0'>
            <div class=''>
              ...
              <div class='row'>
                ...
                <div class='col-sm-6 m-b-15'>
                  <div class='group enter-mobile-number'>
                     <input type='text' name='user_mobile' placeholder='Your mobile number' id='user_mobile' minlength='10' maxlength='10' class='form-control careers-form-border number-field input-value scheduleflag'>
                  </div>
                </div>
                </div>
              <div class='row'>
             ...
             <div class='row'>
                ...
                <div class='col-sm-6 mt-4'>
                  ...
                  <div class='form-group select-theme filter-dropdown border-bottom-0'>
                    ...
                    <img class='icon' src=".$time_img." />
                    <div class='dropdown-menu schedule_time_show left-0'>
                      <ul>
                        <li><a><img src='".get_template_directory_uri()."/images/drop-tick.jpg' alt=''>All day</a></li>
              ...
              <div class='row justify-content-center m-t-50'>
                  ...
                  <div class='col-sm-4'>
                    <button type='button' onClick= next_section('second_detail_section','third_detail_section','schedulebar2','schedulebaricon3','$activePage','tab'); class='btn btn-theme w-100'>next <img class='btn-whitearrow' src='".get_template_directory_uri()."/images/whiteforward.png'></button>
                  </div>
              </div>
            </div>
      ...
      <!--<h3 class='graybg-head'>Shan Chopra, an Investor</h3>-->
        <h3 class='sub-heading'>Step 3/3</h3>
          <h2 class='main-heading overflow-hide m-b-40'>How can we help you?</h2>
          <div class='row tabview'>
            <div class='col-sm-12'>
                ...
                <div class='tab-content' id='nav-tabContent'>
                  ...
                  <div class='tab-pane fade' id='nav-Learning' role='tabpanel' aria-labelledby='nav-Learning-tab'>
                    <div class='row'>
                      ...
                      <div class='col-sm-4'>
                        <div class='choosen-box choose-service english-language-preparation' id='Global Learning' id='Global Learning' data-mydata='English Language Preparation'>
                          <img class='mt-3 mx-auto mb-2 img-fluid default-img' src='".get_template_directory_uri()."/images/global-learn-icon2.png' />
        ...
        <h3 class='sub-heading'>almost there</h3>
          <h2 class='main-heading overflow-hide m-b-60'>Double check the details</h2>
          <div class='row location-details'>
            ...
            <input type='hidden' name='ProspectID' id='ProspectID' >
            <div class='row justify-content-center m-t-60 m-b-20'>
              <div class='col-sm-5 text-center'>
                <button type='button' onclick=show_section(); class='btn btn-link'>GO BACK</button>
              </div>
              <div class='col-sm-7'>
                <button type='button' onclick=onSchedule('tab'); class='btn btn-theme'>schedule your meeting<img class='' src='".get_template_directory_uri()."/images/right-whitearrow.png' /> </button>
              </div>
            </div>
        ...
        <h3 class='sub-heading'>that’s it!</h3>
            ...
            <p class='text-center fs-14'>We will reach you shortly and start our journey together.</p>
              <div class='row justify-content-center m-t-50'>
                <div class='col-sm-7'>
                  <button type='button' class='btn btn-theme w-100 px-0'><a class='text-white' href=".$current_page_url.">Back to ".$current_pageName."<img class='' src=".get_template_directory_uri()."/images/whiteforward.png /></a></button>
                </div>
              </div>
        </div>
...
function sectionDetail($atts){
  ...
  $campaign_section .='<div class="locations-experience-centres global-space p-t-60 p-b-60">
      <div class="container-fluid">
        ...
        <div class="row p-t-40">
          ...
          <div class="col-sm-6">
            ...
            <div class="col-sm-9 p-0">
              <a href="'.$link.'" '.$popup_action.'><button type="button" class="btn btn-theme btn-block">'.$button.'</button></a>
            </div>
            </div>
          </div>
        </div>
...
$campaign_form = '';
$campaign_form .='<div class="formbottom banner-contact-form">
                <div class="formheading m-b-40">'.$form_title.''.$form_subtitle.'</div>
            ...
            <div class="termslink">
               <div class="customcheckbox">
                  ...
                  <label for="campaignTerms" id="campaignTermserror" class="mb-0" ><span >Accept Tc Globals <a href="'.get_permalink(134).'">Terms & Conditions</a> and <a href="'.get_permalink(3).'">Privacy Policy</a></span></label>
               </div>
            </div>
...
$campaign_detail .='<div class="tablet-globaled-learning-leadership p-t-40 global-space bg-gray">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6 templateone-timeline">
            <h2 class="tablet-main-heading text-left overflow-hide m-b-30">'.$title.'</h2>
            ...
            if($campaign_query->have_posts()) :
              ...
              $campaign_detail .='<li class="p1">
                <div class="row align-items-center">
                  <div class="col-sm-2 pr-0 icon">
                    <img src="'.$timeline_arrow_img[0].'" alt="" class="img-fluid" />
                  </div>
                  <div class="col-sm-10">
                    <p class="font-bold">'.get_post_field('post_content', $timelineID).'</p>
                  </div>
                </div>
              </li>';
      ...
      $campaign_detail .='</ul>
            <div class="col-sm-10 ml-5 m-t-25">
      ...
      $campaign_detail .='<div class="col-sm-6 pl-0">
            <div class="tablet-contactblock p-0 mx-auto col-sm-12 floating-contact">';
...
function getCountryFAQ($atts){
  ...
  $countryfaq .= ' <div class="col-sm-12 m-t-40 p-0">
      <div class="tablet-faq-verticaltab country-detail-accordion">
      <h4>'.$faqtitle.'</h4>
...
<div class="row">
<div class="col-sm-7 tablet-faq-verticaltab"><h4><span class="d-block">Didn\'t find the answer?</span>Explore our Help Center</h4></div>
<div class="col-sm-5">
...
if ( $parent->have_posts() ) :
  ...
  $coursecount = get_post_meta( $post->ID, 'course_count', true );
        ...
        $countryContent .= '<div class="col-sm-6 m-b-30">
           <div class="course-list">
             <div class="img-sec">
               <img src="'.$country_img[0].'" alt="course-img" class="img-fluid thumb-img-conver">
               <!--<a class="addfav" href=""><img src="images/added-fav.png" alt="course-img" class="img-fluid"></a>-->
             </div>
               <div class="col-sm-12 searchcoutry-about-count">
                 <div class="row align-items-center mb-2 pb-1 ml-0">
  ...
  if ( $max_pagenum > 1 )
  {
    $countryBtn .= '<div class="col-sm-12 p-b-30 text-center">
...
$memQuery = new WP_Query(
 ...
 $speakerlist .='<div class="tablet-about-leadership p-t-60 p-b-40 global-space">
      <div class="container-fluid">
        <h2 class="tablet-main-heading m-b-60">'.$title.'</h2>
  ...
  if($memQuery->have_posts()) :
    while ($memQuery->have_posts()) : $memQuery->the_post();
      ...
      $speakerlist .='<div class="col-sm-3 member-list">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12 p-b-20">
            <h2 class="tablet-main-heading m-b-60">'.$logotitle.'</h2>
          </div>
        </div>
...
global $post;
  ...
  $scheduleContent .='<div class="schedule-section bg-gray p-t-60 p-b-40 global-space">
      <h2 class="tablet-main-heading">'.$scheduletitle.'</h2>
    ...
    if($scheduleQuery->have_posts()) :
        ...
        $scheduleContent .='<div class="col-sm-4">
            <div class="list">
              <h2>'.$splitdate[0].'</h2>
              <h3>'.$splitdate[1].'</h3>
              ...
              <div class="row">
                ...
                if($schedule_start_time){
                  $scheduleContent .='<div class="col-10 pl-2"><p>'.$schedule_start_time.'-'.$schedule_end_time.'</p></div>';
                }
...
function explore_section($atts){
  ...
  $exploreContent .= '<div class="list-content-section p-t-40 p-b-60">
      <div class="container-fluid">
        <h2 class="tablet-main-heading">'.$explore_title.'</h2>
        <div class="row p-t-40 p-b-20 global-space">';
   ...
   if($exploreQuery->have_posts()) :
      ...
      $exploreContent .= '<div class="col-sm-6 p-b-40">
            <div class="row">
