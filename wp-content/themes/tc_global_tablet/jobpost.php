  ...
  $cat_array = array(
   ...
   foreach ($assigncat as $key => $value) {
      ...
      /*$post_args = array(
        ...
        $job_cat_list .='<div class="col-sm-6 m-b-30">
          ...
          $job_cat_list_show .='<div class="col-sm-6 m-b-30">
            <div class="content-list">';
            if($cat_img) {
        ...
        if($j == 1){
            ...
            $section_one .='<div>
                  <div class="tab-pane show">
                    <div class="row">
                      <div class="col-sm-6 p-t-60">
                        <h6 class="tablet-sub-heading text-left mb-2">Our values</h6>
...
/** career slider - end **/
  ...
  $career_list .='<div class="col-sm-4">
            <div class="list-detail m-b-30">
            ...
            if($jobLocName){
              ...
              $career_list .='<div class="row">
                ...
                <div class="col-10 pl-2">
                  <p class="fs-14"><span>'.$jobLocName.', </span> '.$job_country->name.' </p>
                </div>
              </div>';
             } 
...
<form name="career_search_form" method="get" id="career_search_form" action="" role="search">
  ...
  <div class="searchtool-banner careers-banner" style="background: url(<?php echo $banner_image[0]; ?>) center !important;">
            ...
            <div class="col-sm-11">
              <div class="row">
                <div class="col">
                  ...
                  <div class="dropdown select-theme filter-dropdown pl-0 mt-1">
                ...
                <div class="col">
                  <label>Which team woild you like to join?</label>
                  <div class="dropdown select-theme filter-dropdown pl-0 mt-1">
    ...
    <div class="careers-current-position">
      <div class="container-fluid">
        <div class="row search-result pb-2">
          <div class="col-sm-5">
             <h2 class="main-heading text-left"><span class="d-block">Current open</span>job positions</h2>
          </div>
          <div class="col-sm-7 pt-2 text-right">
            <div class="dropdown d-inline-block">
              <button class="btn btn-secondary dropdown-toggle sub-career" type="button">
                <span><?php echo $sub_team_val; ?></span>
              </button>
      ...
      <div class="row justify-content-center">
          <div class="col-sm-5 text-center m-t-10">
  ...
  <div class="gray-bg clearfix careers-jobs-team p-b-60 p-t-60">
      <div class="container-fluid">
        ...
        <div class="row career_team_hide">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-12 text-center m-t-10 career_team_show" <?php echo $show_teamBtn; ?>>
            ...
            <div class="col-sm-12 text-center m-t-10 career_team_hide">
...
<!--<div class="tablet-icon-horizontaltab careers-verticaltab gray-bg p-t-20 p-b-40 global-space">
<div class="container-fluid">
<div class="row">

<div class="col-sm-12">
  <div class="nav nav-tabs flex-column nav-pills clearfix px-0 career_section_tab">
...
<div class="tablet-icon-horizontaltab career-htab-section p-b-60">
  <div class="container">
    <div class="row">
