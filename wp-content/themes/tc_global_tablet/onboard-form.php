...
<section class="tablet-mainsection">
  ...
  <div class="container-fluid">
    <div class="onboard-questions-section contactform-modal start-journeymodal m-t-30 m-b-50">
      ...
      <h2 class="main-heading overflow-hide m-b-30 m-t-60">We have few simple questions for you.</h2>
      <div class="row">
        <div class="col-sm-4">
          ...
          <div class="dropdown select-theme filter-dropdown pl-0 m-b-20">
            ...
            <div class="dropdown-menu exp_center_show left-0">
        ...
        <ul class="select-list">
            ...
            <div class="col-sm-12">
                ...
                <ul class="select-list">
                    ...
                    <div class="col-sm-3">
                      <button type="button" onclick="onBoardSubmit()" class="btn btn-theme w-100 px-0 onboard-submit">onboard<img class="" src="<?php echo bloginfo('template_url') ?>/images/right-whitearrow.png" /><i class='onboardloader fa fa-spinner fa-spin ml-3' style='display:none'></i> </button>
                    </div>
                  </div>
              </div>
            </div>
