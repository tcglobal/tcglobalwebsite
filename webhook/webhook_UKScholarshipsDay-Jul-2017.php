...
$Interested_in_Pursuing=rawurldecode(trim($_GET['i_would_like_to_attend_the_UKSchloarshipsDay_in']));
...
$subcategary="FB-Leadsbbridge-UK-Scholarships-Day17";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-UK-Scholarships-Day17-'.$maincategary;
$remarks = 'FB-Leadsbbridge-UK-Scholarships-Day17';
