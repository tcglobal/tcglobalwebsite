...
$level_of_study=rawurldecode(trim($_GET['level_of_study']));
$level_of_study=((empty($level_of_study))?'NULL':"".$level_of_study."");

$i_would_like_to_study_in=rawurldecode(trim($_GET['i_would_like_to_study_in']));
$i_would_like_to_study_in=((empty($i_would_like_to_study_in))?'NULL':"".$i_would_like_to_study_in."");
...
$subcategary="FB-Leadsbbridge-Country-Course-Campaign-Aug-19";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-Country-Course-Campaign-Aug-19-'.$maincategary;
$remarks = 'FB-Leadsbbridge-Country-Course-Campaign-Aug-19';
 $queryInsert="INSERT INTO webquery(studid,name,phone,email,city,question,entereddate,maincategary,subcategary,remarks,type,adset_name,level_of_study,i_would_like_to_study_in,ameyo_lead)
values($sid,$name,$phone,'$email',$cityid,'$quest',now(),'$maincategary','$subcategary','$remarks','$Paid','$adset_name','$level_of_study','$i_would_like_to_study_in',true)";	
