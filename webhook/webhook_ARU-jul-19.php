...
$area_of_study=rawurldecode(trim($_GET['area_of_study']));
$area_of_study=((empty($area_of_study))?'NULL':"".$area_of_study."");
...
$subcategary="FB-Leadsbbridge-Anglia-Ruskin-University-July-2019";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-Anglia-Ruskin-University-July-2019-'.$maincategary;
$remarks = 'FB-Leadsbbridge-Anglia-Ruskin-University-July-2019';
 $queryInsert="INSERT INTO webquery(studid,name,phone,email,city,question,entereddate,maincategary,subcategary,remarks,type,adset_name,level_of_study,area_of_study)
values($sid,$name,$phone,'$email',$cityid,'$quest',now(),'$maincategary','$subcategary','$remarks','$Paid','$adset_name','$level_of_study','$area_of_study')";	
