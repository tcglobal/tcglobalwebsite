...
//------------------------------------If Investor Lead Id is not available----------------------------------------
if($leadid=="")
{
...
{
$leasesourceid=$ro['id'];
//pg_query("insert into leadsource(leadid,web) values ($leasesourceid,true);");
}
...
$subcategary="FB-Leadsbbridge-EB5-Invester-Visa-Nov18";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-EB5-Invester-Visa-Nov18'.$maincategary;
$remarks = 'FB-Leadsbbridge-EB5-Invester-Visa-Nov18';
