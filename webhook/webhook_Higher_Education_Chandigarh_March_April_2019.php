...
$Interested_in_Pursuing=rawurldecode(trim($_GET['i_would_like_to_higher_education_Chandigarh_March_April_2019']));
...
$subcategary="FB-Leadsbridge-Higher-Education-Chandigarh-March-April-19";
$Paid = "Paid";		
$quest='FB-Leadsbridge-Higher-Education-Chandigarh-March-April-19-'.$maincategary.$Interested_in_Pursuing;
$remarks = 'FB-Leadsbridge-Higher-Education-Chandigarh-March-April-19';
...
$foremail = "webqueries@thechopras.com";
			...
			sendsms($sid,$mobile);
		mailToCounselor($sid,$name,$email,$phone,$mobile,$city,$quest,$foremail);
