...
$ad_name=rawurldecode(trim($_GET['ad_name']));
$adset_name=rawurldecode(trim($_GET['adset_name']));
$q1=rawurldecode(trim($_GET['would_you_like_to_attend_the_global_career_summit_on_feb_22nd,_2018?']));
$q2 =rawurldecode(trim($_GET['which_country_would_you_like_to_study_in?']));
$q3 =rawurldecode(trim($_GET['what_are_you_planning_to_study?']));
...
$subcategary="FB-Leads-GEI-Singaporefeb18Instagram";
$Paid = "Paid";		
$quest='GEI-Singaporefeb18Instagram-Registration-'.$maincategary.'_'.$Interested_in_Pursuing;
$remarks = 'FB-Leads-GEI-Singaporefeb18Instagram';
