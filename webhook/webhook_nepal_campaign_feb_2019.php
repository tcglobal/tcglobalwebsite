...
$subcategary="FB-Leadsbridge-Nepal-Study-AbroadFeb19";
$Paid = "Paid";		
$quest='FB-Leadsbridge-Nepal-Study-AbroadFeb19-'.$maincategary.'_'.$Interested_in_Pursuing;
$remarks = 'FB-Leadsbridge-Nepal-Study-AbroadFeb19';
 $queryInsert="INSERT INTO webquery(studid,name,phone,email,city,question,entereddate,maincategary,subcategary,remarks,type,adset_name,i_would_like_to_study_in)
values($sid,$name,$phone,'$email',$cityid,'$quest',now(),'$maincategary','$subcategary','$remarks','$Paid','$adset_name','$i_would_like_to_study_in')";	
