...
if($studid=="")
{
 $query="INSERT INTO studmast(fname,lname,cityid,mobile,email,dateentered,throughweb,registered,datecame,modecame,pcounsel) VALUES($name,$lname,$cityid,$mobile,'$email',now(),true,false,now(),17,$pcounselor)";
//webconfig::DBConnect();
...
$subcategary="FB-Leadsbbridge-PSB-sept-2017";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-PSB-sept-2017'.$maincategary;
$remarks = 'FB-Leadsbbridge-PSB-sept-2017';
 $queryInsert="INSERT INTO webquery(studid,name,phone,email,city,question,entereddate,maincategary,subcategary,remarks,type)values($sid,$name,$phone,'$email',$cityid,'$quest',now(),'$maincategary','$subcategary','$remarks','$Paid')";	
...
<p>The Chopras, one of Indias largest and most successful global education experts, is known for providing a holistic view of the opportunities for students seeking overseas education. Incepted in the year 1995, The Chopras has evolved to become a one-stop-solution for every student’s study abroad requirement.</p> 
