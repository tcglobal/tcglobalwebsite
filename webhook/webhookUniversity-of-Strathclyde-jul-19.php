...
$i_would_like_to_study=rawurldecode(trim($_GET['i_would_like_to_study']));
$i_would_like_to_study=((empty($i_would_like_to_study))?'NULL':"".$i_would_like_to_study."");
...
$subcategary="FB-Leadsbbridge-University-of-Strathclyde-Jul-19";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-University-of-Strathclyde-Jul-19-'.$maincategary;
$remarks = 'FB-Leadsbbridge-University-of-Strathclyde-Jul-19';
...
values($sid,$name,$phone,'$email',$cityid,'$quest',now(),'$maincategary','$subcategary','$remarks','$Paid','$adset_name','$i_would_like_to_study')";	
