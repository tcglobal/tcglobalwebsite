<?php
	...
	*/
	...
	$venuAddress	= 'the chopras office bangalore';
	...
	if(strtolower(trim($_GET['i_would_like_to_attend_global_education_interact_in']))=="the chopras office kolkata"){
		$city	= "Kolkata";
		$branch = "Kolkata";
	...
	if(strtolower(trim($_GET['i_would_like_to_attend_global_education_interact_in']))=="the chopras office mumbai andheri west"){
	...
	if(strtolower(trim($_GET['i_would_like_to_attend_global_education_interact_in']))=="the chopras office ncr gurgaon"){
		$city	= "NCR Gurgaon";
		$branch = "NCR Gurgaon";
	...
	if(strtolower(trim($_GET['i_would_like_to_attend_global_education_interact_in']))=="the chopras office ncr north delhi"){
	...
	if(strtolower(trim($_GET['i_would_like_to_attend_global_education_interact_in']))=="the chopras office ncr west delhi"){
		$city	= "NCR West Delhi";
	...
	if(strtolower(trim($_GET['i_would_like_to_attend_global_education_interact_in']))=="the chopras office pune"){
		$city	= "Pune";
		$branch = "Pune";
	...
	$data_string = '[
			...
			{"Attribute":"mx_Fair_Type","Value": "Universityofqueensland"},
			{"Attribute":"Source","Value": "Facebook"},			
			{"Attribute":"SourceCampaign","Value": "Universityofqueensland"},						
			{"Attribute":"mx_choprasleadsource","Value": "Universityofqueensland"},
			...
			if($relatedid != '')
			{
				...
				if($recordcount == 0 || $recordcount == '')
				{
					...
					"EmailAddress": "'.$email.'",
					"ActivityEvent": 192,
					"ActivityNote": "Universityofqueensland",				
					"Fields": [
						{
							"SchemaName": "mx_Custom_1",
							"Value": "Universityofqueensland"
						},						
						{
				...
				if($recordcount > 0)
				{
					for($i=0;$i<$recordcount;$i++)
					{
						...
						if($Custom_1=='Universityofqueensland')
						{
							$data_string = '{
