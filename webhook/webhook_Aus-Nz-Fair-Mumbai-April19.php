<?php 
	...
	$Interested_in_Pursuing	= rawurldecode(trim($_GET['i_would_like_to_attend_aus_nz_day_2019_in']));
	...
	$subcategary= "FB-Leadsbridge-Aus-Nz-Mumbai-April19";
	$Paid 		= "Paid";		
	$quest		= 'FB-Leadsbridge-Aus-Nz-Mumbai-April19-'.$maincategary.$Interested_in_Pursuing;
	$remarks	= 'FB-Leadsbridge-Aus-Nz-Mumbai-April19';
	...
	callbackweb($sid,$pcounselor,$remarks);
	///
