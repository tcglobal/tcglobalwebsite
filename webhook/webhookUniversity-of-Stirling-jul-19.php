...
$subcategary="FB-Leadsbbridge-University-of-Stirling-Jul-19";
$Paid = "Paid";		
$quest='FB-Leadsbbridge-University-of-Stirling-Jul-19-'.$maincategary;
$remarks = 'FB-Leadsbbridge-University-of-Stirling-Jul-19';
 $queryInsert="INSERT INTO webquery(studid,name,phone,email,city,question,entereddate,maincategary,subcategary,remarks,type,adset_name,level_of_study)
values($sid,$name,$phone,'$email',$cityid,'$quest',now(),'$maincategary','$subcategary','$remarks','$Paid','$adset_name','$level_of_study')";	
